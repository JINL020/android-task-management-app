...
//        Date creationDate = new Date(jsonObject.get("creationDate").getAsLong());
        ...
        return new TaskChecklist(taskName,description,priority,status,category,subtasks,attachments,sketchData,taskColor);
    }
}
