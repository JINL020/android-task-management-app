...
public interface ITaskChecklistDao {
    ...
    @Query("SELECT id, taskName, description, priority, status, category, isSelected, isHidden, creationDate, subtasks, attachments, sketchData, taskColor FROM task_checklists")
